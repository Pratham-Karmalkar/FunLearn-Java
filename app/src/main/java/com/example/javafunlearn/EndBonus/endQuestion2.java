...
import com.example.javafunlearn.MidBonus.Question3;
import com.example.javafunlearn.R;

import java.util.Timer;
import java.util.TimerTask;

public class endQuestion2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_end_question2);
    ...
    public void activitySwitch() {
        ...
        timer.schedule(new TimerTask() {
            @Override
            public void run() {
                Intent intent = new Intent(endQuestion2.this, endQuestion3.class);
    ...
    public  void RightWrong(){
        ...
        wrong = Toast.makeText(endQuestion2.this, "Wrong!", Toast.LENGTH_SHORT);
        correct = Toast.makeText(endQuestion2.this, "Correct!", Toast.LENGTH_SHORT);
