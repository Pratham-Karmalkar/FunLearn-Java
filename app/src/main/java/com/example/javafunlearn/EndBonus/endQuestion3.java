...
public class endQuestion3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_end_question3);
    ...
    public void activitySwitch() {
        ...
        timer.schedule(new TimerTask() {
            @Override
            public void run() {
                Intent intent = new Intent(endQuestion3.this, endQuestion4.class);
    ...
    public  void RightWrong(){
        ...
        wrong = Toast.makeText(endQuestion3.this, "Wrong!", Toast.LENGTH_SHORT);
        correct = Toast.makeText(endQuestion3.this, "Correct!", Toast.LENGTH_SHORT);
