...
public class endQuestion5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_end_question5);
    ...
    public void activitySwitch() {
        ...
        timer.schedule(new TimerTask() {
            @Override
            public void run() {
                Intent intent = new Intent(endQuestion5.this, endQuestion6.class);
    ...
    public  void RightWrong(){
        ...
        wrong = Toast.makeText(endQuestion5.this, "Wrong!", Toast.LENGTH_SHORT);
        correct = Toast.makeText(endQuestion5.this, "Correct!", Toast.LENGTH_SHORT);
