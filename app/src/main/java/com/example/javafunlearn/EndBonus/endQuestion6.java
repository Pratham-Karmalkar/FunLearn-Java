...
public class endQuestion6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_end_question6);
    ...
    public void activitySwitch() {
        ...
        timer.schedule(new TimerTask() {
            @Override
            public void run() {
                Intent intent = new Intent(endQuestion6.this, endQuestion7.class);
    ...
    public  void RightWrong(){
        ...
        wrong = Toast.makeText(endQuestion6.this, "Wrong!", Toast.LENGTH_SHORT);
        correct = Toast.makeText(endQuestion6.this, "Correct!", Toast.LENGTH_SHORT);
