...
public class endQuestion7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_end_question7);
    ...
    public void activitySwitch() {
        ...
        timer.schedule(new TimerTask() {
            @Override
            public void run() {
                Intent intent = new Intent(endQuestion7.this, endQuestion8.class);
    ...
    public  void RightWrong(){
        ...
        wrong = Toast.makeText(endQuestion7.this, "Wrong!", Toast.LENGTH_SHORT);
        correct = Toast.makeText(endQuestion7.this, "Correct!", Toast.LENGTH_SHORT);
