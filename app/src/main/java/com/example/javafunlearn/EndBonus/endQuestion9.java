...
public class endQuestion9 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_end_question9);
    ...
    public void activitySwitch() {
        ...
        timer.schedule(new TimerTask() {
            @Override
            public void run() {
                Intent intent = new Intent(endQuestion9.this, endQuestion10.class);
    ...
    public  void RightWrong(){
        ...
        wrong = Toast.makeText(endQuestion9.this, "Wrong!", Toast.LENGTH_SHORT);
        correct = Toast.makeText(endQuestion9.this, "Correct!", Toast.LENGTH_SHORT);
