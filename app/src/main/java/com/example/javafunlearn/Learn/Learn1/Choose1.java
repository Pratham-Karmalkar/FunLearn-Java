    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        read.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent playIntent = new Intent(Choose1.this, Learn1.class);
        ...
        video.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Uri uri = Uri.parse("https://www.youtube.com/watch?v=iFzA43xR04s"); // missing 'http://' will cause crashed
        ...
        toHome.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Choose1.this, LearnLevels.class);
                startActivity(i);
                try {
