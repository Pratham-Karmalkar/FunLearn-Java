...
public class Choose2 extends AppCompatActivity {
MyService1 ms;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        read.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent playIntent = new Intent(Choose2.this, Learn2.class);
        ...
        video.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Uri uri = Uri.parse("https://www.youtube.com/watch?v=YdB1K9bjYaM"); // missing 'http://' will cause crashed
        ...
        toHome.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Choose2.this, LearnLevels.class);
                startActivity(i);
                try {
