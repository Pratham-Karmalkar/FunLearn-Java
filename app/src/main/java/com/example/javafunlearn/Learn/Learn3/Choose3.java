...
import com.example.javafunlearn.Learn.Learn2.Learn2;
...
public class Choose3 extends AppCompatActivity {
    MyService1 ms;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        read.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent playIntent = new Intent(Choose3.this, Learn3.class);
        ...
        video.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Uri uri = Uri.parse("https://www.youtube.com/watch?v=XOCxhEn-_A0"); // missing 'http://' will cause crashed
        ...
        toHome.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Choose3.this, LearnLevels.class);
                startActivity(i);
                try {
