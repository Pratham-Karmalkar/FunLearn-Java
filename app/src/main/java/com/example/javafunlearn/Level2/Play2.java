package com.example.javafunlearn.Level2;
...
public class Play2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        wrong = Toast.makeText(Play2.this, "Wrong!", Toast.LENGTH_SHORT);
        correct = Toast.makeText(Play2.this, "Correct!", Toast.LENGTH_SHORT);
        ...
        level_select.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(Play2.this, Levels.class);
                startActivity(i);
            }
        });
