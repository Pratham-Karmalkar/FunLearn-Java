package com.example.javafunlearn.Level3;
...
public class Play3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        wrong = Toast.makeText(Play3.this, "Wrong!", Toast.LENGTH_SHORT);
        correct = Toast.makeText(Play3.this, "Correct!", Toast.LENGTH_SHORT);
        ...
        level_select.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(Play3.this, Levels.class);
                startActivity(i);
            }
        });
