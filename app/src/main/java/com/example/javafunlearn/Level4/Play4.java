package com.example.javafunlearn.Level4;
...
public class Play4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        wrong = Toast.makeText(Play4.this, "Wrong!", Toast.LENGTH_SHORT);
        correct = Toast.makeText(Play4.this, "Correct!", Toast.LENGTH_SHORT);
        ...
        level_select.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(Play4.this, Levels.class);
                startActivity(i);
            }
        });
