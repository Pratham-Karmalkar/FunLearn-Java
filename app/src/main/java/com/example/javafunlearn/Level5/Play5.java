package com.example.javafunlearn.Level5;
...
public class Play5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        wrong = Toast.makeText(Play5.this, "Wrong!", Toast.LENGTH_SHORT);
        correct = Toast.makeText(Play5.this, "Correct!", Toast.LENGTH_SHORT);
        ...
        level_select.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(Play5.this, Levels.class);
                startActivity(i);
            }
        });
