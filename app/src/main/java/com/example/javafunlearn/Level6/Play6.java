package com.example.javafunlearn.Level6;
...
public class Play6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        wrong = Toast.makeText(Play6.this, "Wrong!", Toast.LENGTH_SHORT);
        correct = Toast.makeText(Play6.this, "Correct!", Toast.LENGTH_SHORT);
        ...
        level_select.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(Play6.this, Levels.class);
                startActivity(i);
            }
        });
