package com.example.javafunlearn.Level7;
...
public class Play7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        wrong = Toast.makeText(Play7.this, "Wrong!", Toast.LENGTH_SHORT);
        correct = Toast.makeText(Play7.this, "Correct!", Toast.LENGTH_SHORT);
        ...
        level_select.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(Play7.this, Levels.class);
                startActivity(i);
            }
        });
