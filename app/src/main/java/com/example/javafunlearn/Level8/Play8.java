package com.example.javafunlearn.Level8;
...
public class Play8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        wrong = Toast.makeText(Play8.this, "Wrong!", Toast.LENGTH_SHORT);
        correct = Toast.makeText(Play8.this, "Correct!", Toast.LENGTH_SHORT);
        ...
        level_select.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(Play8.this, Levels.class);
                startActivity(i);
            }
        });
        ...
        b40.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                b40.setBackgroundColor(Color.GREEN);
                correct.show();
            }
       });
    }
