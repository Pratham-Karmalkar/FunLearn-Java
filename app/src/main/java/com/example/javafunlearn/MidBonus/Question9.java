...
public class Question9 extends Questions {
    int q9=1;
    Timer timer;
    @Override
    ...
    public  void RightWrong() {
        ...
        bt1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                score = +1;
                Toast.makeText(Question9.this, "Wrong", Toast.LENGTH_SHORT).show();
        ...
        bt4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(Question9.this, "Correct", Toast.LENGTH_SHORT).show();
